    ...
    <main className="min-h-screen bg-slate-950 px-4 py-10 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        <div className="mb-8">
          ...
          <p className="mt-3 text-sm text-slate-400">Last updated: September 16, 2026</p>
        </div>

        <div className="space-y-8 text-[15px] leading-7 text-slate-300">
          <section>
            <h2 className="mb-3 text-xl font-semibold text-white">Our commitment to child safety</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-white">Prohibited content and behavior</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-white">Reporting child safety concerns</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-white">Moderation and enforcement</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-white">Legal compliance and reporting</h2>
            <p>
