...
export default function ReelsPage() {
  ...
  if (loading) return (
    <div className="flex min-h-[calc(100vh-88px)] items-center justify-center bg-black">
