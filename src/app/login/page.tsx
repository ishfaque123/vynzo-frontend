...
function GoogleIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 48 48">
      ...
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.2 4.2-11.3 8-6.1 0-11.6-3.7-13.9-9l6.6-5.1C16.4 33.7 20.8 36 24 36c5.2 0 9.7-3.3 11.3-8H24v-8h18c.4 1.2.6 2.6.6 4.5 0 6.5-2.5 12.1-6.3 14.9z" />
    </svg>
  );
}
